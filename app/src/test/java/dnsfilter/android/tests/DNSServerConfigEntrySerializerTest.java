...
public class DNSServerConfigEntrySerializerTest {
    ...
    public void DNSServerConfigEntryDeserializationTest() {
        ...
        HashMap<String, DNSServerConfigBaseEntry> testResults = new HashMap<String, DNSServerConfigBaseEntry>() {{
            ...
            put("204.106.240.53::47038::dot::dot.tiar.app", new DNSServerConfigEntry("204.106.240.53", "47038", DNSType.DOT, "dot.tiar.app", true));
            ...
            put("203.126.118.38::3758::dot::dot-sg.blahdns.com", new DNSServerConfigEntry("203.126.118.38", "3758", DNSType.DOT, "dot-sg.blahdns.com", true));
